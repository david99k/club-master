      ...
      <div className="container flex h-16 items-center justify-between px-4">
        <Link href="/" className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <div className="text-xs text-white/70 leading-tight">실시간 코트 매칭 시스템</div>
          </div>
        </Link>
        <div className="flex items-center gap-2">
          {isAdmin && (
            <Link href="/admin/courts">
              <Button variant="ghost" size="sm" className="text-white/90 hover:text-white hover:bg-white/15 gap-1.5">
          ...
          {member && (
            <div className="flex items-center gap-2">
              ...
              <form action={signOut}>
                <Button variant="ghost" size="sm" type="submit" className="text-white/70 hover:text-white hover:bg-white/15">
                  로그아웃
                </Button>
              </form>
            </div>
